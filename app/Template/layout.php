...
<html lang="<?= $this->app->jsLang() ?>">
    <head>
        ...
        <link rel="apple-touch-icon" href="<?= $this->url->dir() ?>assets/img/favicon.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?= $this->url->dir() ?>assets/img/favicon.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?= $this->url->dir() ?>assets/img/favicon.png">
        <link rel="apple-touch-icon" sizes="144x144" href="<?= $this->url->dir() ?>assets/img/favicon.png">
